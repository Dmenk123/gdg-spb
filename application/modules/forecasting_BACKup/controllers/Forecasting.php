...
class Forecasting extends CI_Controller {
	...
	public function peramalan()
	{
		...
		$queryPemakaian = $this->m_rop->get_pengeluaran_barang($id_barang, $bulan_index);
		...
		$query_grafik = $this->m_ramal->get_pengeluaran_barang_grafik($id_barang, $bulan_forecast, $bulan_end);
