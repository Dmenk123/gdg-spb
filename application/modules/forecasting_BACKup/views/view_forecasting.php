    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <label class="control-label">Pilih Periode bulan yang akan dilakukan peramalan : (data perhitungan setahun, berdasarkan periode sebulan sebelum bulan terpilih)</label>
