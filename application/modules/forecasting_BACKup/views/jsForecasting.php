...
$(document).ready(function() {
    ...
    $('#field_alpha').change(function(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            async : false,
            data : { alpha : alpha, blnIndex : blnIndex, idBarang : idBarang},
            success : function(data) {
                ...
                $('#tbl_peramalan').append('<tr class="tbl_ape_row" id="row_peramalan">'
                                        ...
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_hasil_row" id="row_peramalan">'
                                        +'</tr>');
                $('#tbl_peramalan').append('<tr class="tbl_note_row" id="row_peramalan">'
                                        +'<td colspan="13"><strong>Catatan :</strong> Peramalan yang baik merupakan permalan dengan nilai presentase MAPE terkecil </td></tr>');
                $('.tbl_hasil_row').append('<td colspan="4"><strong>'
                                            ...
                                            +'</strong></td>');
                $('.tbl_hasil_row').append('<td colspan="3"><strong>'
                                                +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">MAD</span></a>'
                                                +' = <span class="hasil_mad">'+data.mad+'</span>'
                                            +'</strong></td>');
                $('.tbl_hasil_row').append('<td colspan="3"><strong>'
                                                +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">MSE</span></a>'
                                                +' = <span class="hasil_mse">'+data.mse+'</span>'
                                            +'</strong></td>');
                $('.tbl_hasil_row').append('<td colspan="3"><strong>'
                                                +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">MAPE</span></a>'
