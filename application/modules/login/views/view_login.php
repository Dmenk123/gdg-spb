...
<div class="login-box">
  ...
  <div class="login-logo">
    <span class="logo-lg"><img src="<?php echo base_url('assets/img/logo_SPB.png');?>"></span> 
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">   
      <p style="font-size: 20px; color:black; font-family: arial;" class="login-box-msg">Silahkan Login</p>
